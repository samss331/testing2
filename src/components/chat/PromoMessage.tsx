...
export const DEBUGGING_TIPS_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      ...
      url: "https://www.ternary-pre-domain.vercel.app/docs/guides/debugging",
    },
  ],
};

// Advanced tip: Customize your AI rules https://www.ternary-pre-domain.vercel.app/docs/guides/ai-rules
export const AI_RULES_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "AI rules",
      url: "https://www.ternary-pre-domain.vercel.app/docs/guides/ai-rules",
    },
  ],
};
...
// Want to know what's next? Checkout our roadmap https://www.ternary-pre-domain.vercel.app/docs/roadmap
export const ROADMAP_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "roadmap",
      url: "https://www.ternary-pre-domain.vercel.app/docs/roadmap",
    },
  ],
};

// Like Ternary? Star it on GitHub https://github.com/ternarystudio/ternary/
export const GITHUB_TIP: MessageConfig = {
  spans: [
    ...
    },
    {
      type: "link",
      content: "GitHub",
      url: "https://github.com/ternarystudio/ternary",
    },
  ],
};
